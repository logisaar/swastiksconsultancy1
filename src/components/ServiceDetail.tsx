...
// Service Details Data Structure (keep your full object here)


const ServiceDetail: React.FC<ServiceDetailProps> = ({ serviceId }) => {
  // Get service details or show not found if service not found
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-16 bg-gradient-card p-12 rounded-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {service.pricing.map((package_item: any, index: number) => (
              <Card key={index} className="relative border border-border/50 hover:border-primary/20 transition-colors shadow-professional">
                ...
                <CardContent>
                  <ul className="space-y-3">
                    {package_item.features.map((feature: string, idx: number) => (
